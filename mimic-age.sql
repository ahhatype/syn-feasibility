...
SELECT 	
	...
	, pa.anchor_age
	, pa.anchor_year
	, (2020 - pa.anchor_year) + pa.anchor_age AS age_as_of_2020 -- age at given date
	, DATETIME_DIFF(ad.admittime, DATETIME(pa.anchor_year, 1, 1, 0, 0, 0), YEAR) + pa.anchor_age AS age -- AGE AS OF JANUARY 1. 2020
